...
class ClientController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->hasRole('Admin|Sales Rep')){
            return view('eezee_holdings.eezee_batteries.client.index');
        } else {
    ...
    {
        if(Auth::user()->hasRole('Admin|Sales Rep')){
            return view('eezee_holdings.eezee_batteries.client.create');
        } else {
            return redirect()->back();
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $client = new Client;
            ...
            $client->email = encrypt($request->email);
    ...
    public function show($id)
    {
        if(Auth::user()->hasRole('Admin|Sales Rep')){
            ...
            return view('eezee_holdings.eezee_batteries.client.show.show', compact('client'));
        } else {
            return redirect()->back();
        }
    }
