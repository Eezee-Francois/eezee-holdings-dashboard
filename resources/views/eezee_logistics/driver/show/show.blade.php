<x-master>
    <x-container>
        ...
        <x-card>
            ...
            <livewire:eezee-logistics.driver.show.details :driver="$driver" />
        </x-card>
        ...
        <x-closed-card>
            ...
            <livewire:eezee-logistics.driver.show.employment-terms :driver="$driver" />
        </x-closed-card>
        ...
        <x-closed-card>
            ...
            <livewire:eezee-logistics.driver.show.truck :driver="$driver" :trucks="$trucks" />
        </x-closed-card>
    </x-container>
</x-master>
