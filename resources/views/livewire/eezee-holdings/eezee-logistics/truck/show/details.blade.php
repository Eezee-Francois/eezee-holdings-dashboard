	...
	<form wire:submit.prevent="saveTruckDetails">
        ...
        <div class="row">
            <div class="col-md-6 pt-5">
                ...
                <input type="text" class="form-control" wire:model.defer="weight_with_unit"/>
                @error('weight_with_unit')
                    <p style="color: red;" class="pt-2">Please enter the Weight in Kg before saving</p>
                @enderror
            </div>
        </div>
