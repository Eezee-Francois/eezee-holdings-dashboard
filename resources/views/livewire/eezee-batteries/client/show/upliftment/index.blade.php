                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="upliftment_date">Size in Tons<span style="color: red"> *</span></label>
                                    <input type="text" class="form-control" id="size" name="size" placeholder="4" required>
                                </div>
                            </div>
                ...
                <x-slot name="data">
                    @forelse($upliftments as $upliftment)
                        <tr>
                            ...
                            <td width="5%">{{ $upliftment->size }} Tons</td>
